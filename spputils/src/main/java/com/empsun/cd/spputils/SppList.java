...
@SuppressLint("NewApi")
public class SppList extends Activity {
    // Debugging
    private static final String TAG = "SppList";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int listId = getIntent().getIntExtra("layout_list", R.layout.spp_list);
        ...
        if(strScanDevice == null) strScanDevice = "搜索设备";
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
	        ...
	        if(!((TextView) v).getText().toString().equals(strNoFound)) {
	            ...
	            intent.putExtra(SppState.EXTRA_DEVICE_ADDRESS, address);
